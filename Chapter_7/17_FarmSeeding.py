# USACO 2019 February Contest, Bronze-Problem 2: The Great Revegetation / Farm Seeding
...
def read_cows(input_file, num_cows):
    ...
    Read the cow's favorite pastures from input_file.
...
def smallest_available(used):
    ...
    Return the smallets-numbered grass type that is not in used.
    """
    grass_type = 1
...
def write_pastures(output_file, pasture_types ):
    ...
    Output pastures_types to output_file
    """
    pasture_types_str = []
